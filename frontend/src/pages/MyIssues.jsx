...
const MyIssues = () => {
  ...
  if(loading){
    return <h1 className="flex items-center justify-center text-xl font-bold min-h-screen"> Loading My Issues....</h1>;
  }
    ...
    <div className="max-w-6xl mx-auto px-6 py-6">
      ...
      <div className="bg-white rounded-lg p-5 flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="px-4 py-2 bg-indigo-900 hover:bg-indigo-800 text-white rounded cursor-pointer"
        >
          + Post New Complaint
        </button>
      </div>
          ...
          >
            <div>
              ...
              <div className="flex gap-2 mb-2">
                ...
                <span className="px-2 py-1 text-xs font-semibold bg-yellow-300 rounded">
