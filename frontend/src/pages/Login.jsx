...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center">
      <div className=" w-[90%] md:w-full max-w-md bg-white rounded-lg p-8">
        <h1 className="text-2xl font-semibold text-center text-indigo-900">
          Campus Echo
        </h1>
        <p className="text-center text-gray-600 mt-1">Login to your account</p>
        ...
        <button
          onClick={handleLogin}
          className="w-full bg-indigo-900 hover:bg-indigo-800 text-white py-2 rounded-md mt-6 cursor-pointer"
        >
          Login
        </button>
